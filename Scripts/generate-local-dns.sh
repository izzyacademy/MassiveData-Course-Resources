...
prepare_service_dns_entry()
{
    ...
    SERVICE_FQDN="$SERVICE_SUBDOMAIN.$DNS_SUFFIX"

    SERVICE_DNS_ENTRY="$SERVICE_EXTERNAL_IP $SERVICE_SUBDOMAIN $SERVICE_FQDN"
...
prepare_service_dns_entry default elasticsearch-external elasticsearch
prepare_service_dns_entry default kibana-external kibana
prepare_service_dns_entry default neo4j-external neo4j

prepare_service_dns_entry redis redis-external redis-db

prepare_service_dns_entry mysql56 mysql-external mysql-db

prepare_service_dns_entry mongo mongo-external mongo-db

prepare_service_dns_entry cassandra cassandra1-external cassandra1
prepare_service_dns_entry cassandra cassandra2-external cassandra2
prepare_service_dns_entry cassandra cassandra3-external cassandra3
